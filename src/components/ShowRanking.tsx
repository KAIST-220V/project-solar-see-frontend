  ...
  return (
    <div className="flex flex-col h-full">
      <main className="p-4">
        ...
        <div className="10th">
          {ranks.length>0 && ranks.map((user, index) => (
            <div key={index} className={`flex items-center justify-between py-2 border-b last:border-b-0 ${user.is_mine ? 'bg-yellow' : 'bg-white'}`}>
              <div className="flex items-center space-x-2">
